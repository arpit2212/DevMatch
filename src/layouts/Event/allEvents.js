...
const AllEvents = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-white via-gray-100 to-white min-h-screen p-6 relative overflow-hidden mt-12">
      ...
      <h2 className="text-4xl font-extrabold text-center text-indigo-700 mb-10 drop-shadow-md">All Upcoming Events</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
            {currentItems.map((event) => (
              ...
              >
                ...
                />
                <h3 className="text-2xl font-bold mb-2 text-indigo-700">{event.title}</h3>
                <p className="text-black mb-3">{event.description}</p>
                <p className="text-sm text-black mb-1">Location: {event.location}</p>
