...
import Rightimg from "../../assets/images/events/right-img-events.svg"; // Adjust the import path if needed
      ...
      <div className="relative z-10 px-4 flex flex-col lg:flex-row justify-center items-center lg:justify-between w-full max-w-7xl mt-16 mb-16 sm:mt-20 sm:mb-20">
        ...
        <div className="text-center lg:text-left w-full lg:w-1/2">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">
            <span className="text-[#3646F5]">Events :</span> Your Gateway to Opportunities
          </h1>
          <p className="text-gray-400 mt-6 max-w-xl mx-auto lg:mx-0 text-sm sm:text-base">
          Events are more than just gatherings – they are dynamic platforms where ideas take shape and opportunities unfold. Imagine a space buzzing with energy, where innovators, creators, and enthusiasts come together to share knowledge, collaborate, and grow. Whether you're looking to host an event, participate in one, or network with like-minded individuals, events offer the perfect stage to showcase your skills, explore new possibilities, and make a lasting impact.          </p>
